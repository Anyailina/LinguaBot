...
public class WordState implements IAdd {
    ...
    public ResultStatusEnum processMessage(AddContext addContext, String text, long chatId) {
        ...
        WordDto wordDto = wordController.getWord(userCacheData.getWordCash().getFolderName(), text,chatId);

        return wordDto == null ? ResultStatusEnum.RIGHT : ResultStatusEnum.MISTAKE;
    ...
    public String wrongAnswer() {
        return "Такого слово уже существует";
    }
