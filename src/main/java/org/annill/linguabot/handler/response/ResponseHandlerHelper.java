...
public class ResponseHandlerHelper {
    ...
    public ResponseHandlerHelper(List<ResponseHandler> handlers) {
        responseHandlerMap = new HashMap<>();
        handlers.forEach(actionHandler -> responseHandlerMap.put(actionHandler.getType(), actionHandler));
    }
    ...
    public ResponseHandler findHandler(ResponseEnum responseEnum) {
        return responseHandlerMap.get(responseEnum);
    }
